...
import kuntaKinte from '../images/kuntaKinte.jpg'

const Panel = () => {
  return (
    <div className="flex flex-col justify-start h-screen bg-gray-100">
    <div className="container mx-auto p-4 flex-grow"> {/* Añadir flex-grow aquí */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-red-500 rounded-lg overflow-hidden shadow-md">
                <img src={kuntaKinte} alt="Description of the image" className="w-full h-auto" />
            </div>
